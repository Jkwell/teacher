      ...
      <div class="password-wrapper">
        <ul class="password-list">
          <li class="password-item">
            <label class="item">邮箱号:</label>
            <input type="text" placeholder="请输入邮箱号" v-model="email" style="width: 70%">
          </li>
...
export default {
  ...
  computed: {
    email: {
      get () {
        return this.$store.state.email === undefined ? '' : this.$store.state.email
      },
      set (value) {
