              ...
              <ul class="list">
                <a href="#" class="href" v-for="(item, index) in teacherInfos" :key="index">
                  <li class="list-item" @click="goChange(item.info, item.title)">
                    ...
                    <div class="tag">
                      <div class="upload" v-if="item.title === '头像'">
                        <img
                          :src="avatars"
                          width="35"
                          height="35"
...
export default {
  data() {
    return {
      ...
      teacherInfos: [
        {
          title: "头像",
          img: require("../../common/image/teacher/savatar@3x.png"),
          info: ""
        },
        {
          title: "姓名",
          img: require("../../common/image/teacher/name@3x.png"),
          info: ""
        },
        {
          title: "性别",
          img: require("../../common/image/teacher/sex@3x.png"),
          info: ""
        },
        {
          title: "手机",
          img: require("../../common/image/teacher/phone@3x.png"),
          info: ""
        },
        {
          title: "邮箱",
          img: require("../../common/image/teacher/email@3x.png"),
          info: ""
        },
        {
          title: "修改密码",
          img: require("../../common/image/teacher/pwd@3x.png"),
          info: ""
        }
      ]
    };
  ...
  methods: {
    ...
    getTeacherInfo() {
      ...
      requestPost("api/teacher/teacherinfo", { token: token }).then(function(
        data
      ) {
        if (data.success === true) {
          ...
          if (data.data.sex === "2") {
            _this.icon = {
              "background-image":
                "url(" + require("../../common/image/teacher/nvv@3x.png") + ")"
            };
          } else if (data.data.sex === "1") {
            _this.icon = {
              "background-image":
                "url(" + require("../../common/image/teacher/nan@3x.png") + ")"
            };
          }
          ...
          requestPost("/up.php", rst.formData).then(function(data) {
            if (data.success === true) {
              ...
              _this.$vux.alert.show({
                ...
                // 数组监听
                onHide() {
                  requestPost("api/teacher/editavatar", {
                    user_avatar: baseSrc,
                    token: token
                  }).then(function(data) {
                    console.log(data);
...
<style lang='sass'>
@import '~@/common/sass/index/footer.sass'
